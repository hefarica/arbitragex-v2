...
export const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/opportunities",        label: "Convergence signals",    icon: SatelliteDishIcon,      group: "pipeline" },
  { href: "/opportunities/by-strategy", label: "By strategy",      icon: LayersIcon,             group: "pipeline" },
  { href: "/executions",           label: "Resolutions",            icon: ZapIcon,                group: "pipeline" },
  ...
  { href: "/operations",           label: "Convergence metrics",    icon: TrendingUpIcon,         group: "pipeline" },
  ...
  { href: "/strategies",           label: "Resolution engines",     icon: SlidersHorizontalIcon,  group: "setup" },
