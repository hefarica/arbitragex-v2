name: arbx-g-g008-advanced-tanstack-query-cache-invalidation
description: "Post-Doc skill alineada al monorepo hefarica/arbitragex-v2 (Frontend Doctrinal (Next.js + Playwright)). Se activa cuando: RSC+Query bridge. Doctrina OMEGA Zero-Mocks · Fail-Closed · El Remoto Manda."
---

# G008 — Advanced TanStack Query Cache Invalidation

> **Dominio:** Frontend Doctrinal (Next.js + Playwright)
> **Nivel:** Post-Doc
> **Trigger:** RSC+Query bridge
...
- `RSC+Query bridge`
- `advanced tanstack query cache invalidation`
- `arbitragex-v2 g`
