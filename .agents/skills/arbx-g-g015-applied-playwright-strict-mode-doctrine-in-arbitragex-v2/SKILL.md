...
# G015 — Applied Playwright Strict Mode Doctrine in arbitragex-v2

> **Dominio:** Frontend Doctrinal (Next.js + Playwright)
> **Nivel:** Staff Engineer
> **Trigger:** rpc-down.spec.ts iter18
...
- `rpc-down.spec.ts iter18`
- `applied playwright strict mode doctrine in arbitragex-v2`
- `arbitragex-v2 g`
