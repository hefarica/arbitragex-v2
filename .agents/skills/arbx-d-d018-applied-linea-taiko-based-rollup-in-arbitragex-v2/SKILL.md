...
# D018 — Applied Linea / Taiko Based-Rollup in arbitragex-v2

> **Dominio:** Multi-Chain, L2 & Bridges
> **Nivel:** Staff Engineer
> **Trigger:** preconfirmation strategy
...
- `preconfirmation strategy`
- `applied linea / taiko based-rollup in arbitragex-v2`
- `arbitragex-v2 d`
