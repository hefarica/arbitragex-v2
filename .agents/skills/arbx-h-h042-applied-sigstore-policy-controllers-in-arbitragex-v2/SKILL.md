name: arbx-h-h042-applied-sigstore-policy-controllers-in-arbitragex-v2
description: "Staff Engineer skill alineada al monorepo hefarica/arbitragex-v2 (CI/CD Doctrinal & DevSecOps). Se activa cuando: arbitragex k8s admission. Doctrina OMEGA Zero-Mocks · Fail-Closed · El Remoto Manda."
---

# H042 — Applied Sigstore Policy Controllers in arbitragex-v2

> **Dominio:** CI/CD Doctrinal & DevSecOps
> **Nivel:** Staff Engineer
> **Trigger:** arbitragex k8s admission
...
- `arbitragex k8s admission`
- `applied sigstore policy controllers in arbitragex-v2`
- `arbitragex-v2 h`
