...
# C012 — Applied Backrunning Atomic Arbitrage in arbitragex-v2

> **Dominio:** MEV, Mempool & Bundle Submission
> **Nivel:** Staff Engineer
> **Trigger:** searcher sub-100ms detect→bundle
...
- `searcher sub-100ms detect→bundle`
- `applied backrunning atomic arbitrage in arbitragex-v2`
- `arbitragex-v2 c`
