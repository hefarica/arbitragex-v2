name: arbx-b-b026-advanced-certora-cvl-formal-verification
description: "Post-Doc skill alineada al monorepo hefarica/arbitragex-v2 (Smart Contracts, Solidity & Auditing). Se activa cuando: ghost variables hooks. Doctrina OMEGA Zero-Mocks · Fail-Closed · El Remoto Manda."
---

# B026 — Advanced Certora CVL Formal Verification

> **Dominio:** Smart Contracts, Solidity & Auditing
> **Nivel:** Post-Doc
> **Trigger:** ghost variables hooks
...
- `advanced certora cvl formal verification`
- `arbitragex-v2 b`
