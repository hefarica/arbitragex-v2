name: arbx-i-i028-chaos-engineering-toxiproxy
description: "PhD/Master skill alineada al monorepo hefarica/arbitragex-v2 (Observability & SRE). Se activa cuando: latency injection. Doctrina OMEGA Zero-Mocks · Fail-Closed · El Remoto Manda."
---

# I028 — Chaos Engineering (toxiproxy)

> **Dominio:** Observability & SRE
> **Nivel:** PhD/Master
> **Trigger:** latency injection
