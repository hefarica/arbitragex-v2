...
# H045 — Applied Self-Hosted Runners + ARC in arbitragex-v2

> **Dominio:** CI/CD Doctrinal & DevSecOps
> **Nivel:** Staff Engineer
> **Trigger:** arbitragex private runners
...
- `arbitragex private runners`
- `applied self-hosted runners + arc in arbitragex-v2`
- `arbitragex-v2 h`
