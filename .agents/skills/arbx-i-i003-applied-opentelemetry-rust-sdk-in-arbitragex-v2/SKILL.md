...
# I003 — Applied OpenTelemetry Rust SDK in arbitragex-v2

> **Dominio:** Observability & SRE
> **Nivel:** Staff Engineer
> **Trigger:** searcher-rs per-opportunity span
...
- `searcher-rs per-opportunity span`
- `applied opentelemetry rust sdk in arbitragex-v2`
- `arbitragex-v2 i`
