...
# I033 — Applied Blameless Postmortems & ADRs in arbitragex-v2

> **Dominio:** Observability & SRE
> **Nivel:** Staff Engineer
> **Trigger:** iter12-13 tokens postmortem
...
- `iter12-13 tokens postmortem`
- `applied blameless postmortems & adrs in arbitragex-v2`
- `arbitragex-v2 i`
