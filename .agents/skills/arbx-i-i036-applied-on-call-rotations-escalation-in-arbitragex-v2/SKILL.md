...
# I036 — Applied On-Call Rotations & Escalation in arbitragex-v2

> **Dominio:** Observability & SRE
> **Nivel:** Staff Engineer
> **Trigger:** arbitragex 24x7 readiness
...
- `arbitragex 24x7 readiness`
- `applied on-call rotations & escalation in arbitragex-v2`
- `arbitragex-v2 i`
