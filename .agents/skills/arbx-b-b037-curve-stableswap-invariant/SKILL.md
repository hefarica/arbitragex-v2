name: arbx-b-b037-curve-stableswap-invariant
description: "PhD/Master skill alineada al monorepo hefarica/arbitragex-v2 (Smart Contracts, Solidity & Auditing). Se activa cuando: Newton iteration A param. Doctrina OMEGA Zero-Mocks · Fail-Closed · El Remoto Manda."
---

# B037 — Curve StableSwap Invariant

> **Dominio:** Smart Contracts, Solidity & Auditing
> **Nivel:** PhD/Master
> **Trigger:** Newton iteration A param
