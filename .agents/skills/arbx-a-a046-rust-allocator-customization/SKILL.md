name: arbx-a-a046-rust-allocator-customization
description: "PhD/Master skill alineada al monorepo hefarica/arbitragex-v2 (Rust Systems & Searcher Engine). Se activa cuando: jemalloc/mimalloc tail latency. Doctrina OMEGA Zero-Mocks · Fail-Closed · El Remoto Manda."
---

# A046 — Rust Allocator Customization

> **Dominio:** Rust Systems & Searcher Engine
> **Nivel:** PhD/Master
> **Trigger:** jemalloc/mimalloc tail latency
...
- `jemalloc/mimalloc tail latency`
- `rust allocator customization`
- `arbitragex-v2 a`
