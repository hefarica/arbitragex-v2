name: arbx-h-h036-applied-dependabot-grouped-renovate-in-arbitragex-v2
description: "Staff Engineer skill alineada al monorepo hefarica/arbitragex-v2 (CI/CD Doctrinal & DevSecOps). Se activa cuando: arbitragex weekly cadence. Doctrina OMEGA Zero-Mocks · Fail-Closed · El Remoto Manda."
---

# H036 — Applied Dependabot Grouped + Renovate in arbitragex-v2

> **Dominio:** CI/CD Doctrinal & DevSecOps
> **Nivel:** Staff Engineer
> **Trigger:** arbitragex weekly cadence
...
- `arbitragex weekly cadence`
- `applied dependabot grouped + renovate in arbitragex-v2`
- `arbitragex-v2 h`
