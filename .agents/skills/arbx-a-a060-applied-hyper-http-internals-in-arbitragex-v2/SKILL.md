...
# A060 — Applied Hyper HTTP Internals in arbitragex-v2

> **Dominio:** Rust Systems & Searcher Engine
> **Nivel:** Staff Engineer
> **Trigger:** alt-svc upgrade in api-server
...
- `alt-svc upgrade in api-server`
- `applied hyper http internals in arbitragex-v2`
- `arbitragex-v2 a`
