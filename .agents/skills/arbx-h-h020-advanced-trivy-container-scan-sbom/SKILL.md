name: arbx-h-h020-advanced-trivy-container-scan-sbom
description: "Post-Doc skill alineada al monorepo hefarica/arbitragex-v2 (CI/CD Doctrinal & DevSecOps). Se activa cuando: CycloneDX SPDX diff. Doctrina OMEGA Zero-Mocks · Fail-Closed · El Remoto Manda."
---

# H020 — Advanced Trivy Container Scan + SBOM

> **Dominio:** CI/CD Doctrinal & DevSecOps
> **Nivel:** Post-Doc
> **Trigger:** CycloneDX SPDX diff
...
- `CycloneDX SPDX diff`
- `advanced trivy container scan + sbom`
- `arbitragex-v2 h`
