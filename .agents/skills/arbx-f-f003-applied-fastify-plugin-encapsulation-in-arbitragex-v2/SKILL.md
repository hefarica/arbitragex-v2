name: arbx-f-f003-applied-fastify-plugin-encapsulation-in-arbitragex-v2
description: "Staff Engineer skill alineada al monorepo hefarica/arbitragex-v2 (Backend Services (Node + Rust)). Se activa cuando: api-server /status route iter18. Doctrina OMEGA Zero-Mocks · Fail-Closed · El Remoto Manda."
---

# F003 — Applied Fastify Plugin Encapsulation in arbitragex-v2

> **Dominio:** Backend Services (Node + Rust)
> **Nivel:** Staff Engineer
> **Trigger:** api-server /status route iter18
...
- `api-server /status route iter18`
- `applied fastify plugin encapsulation in arbitragex-v2`
- `arbitragex-v2 f`
