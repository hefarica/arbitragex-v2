...
# A045 — Applied Rust Lock-Free (crossbeam) in arbitragex-v2

> **Dominio:** Rust Systems & Searcher Engine
> **Nivel:** Staff Engineer
> **Trigger:** opportunity_buffer sub-µs ingest
...
- `opportunity_buffer sub-µs ingest`
- `applied rust lock-free (crossbeam) in arbitragex-v2`
- `arbitragex-v2 a`
