...
# C003 — Applied Mempool WebSocket Subscription in arbitragex-v2

> **Dominio:** MEV, Mempool & Bundle Submission
> **Nivel:** Staff Engineer
> **Trigger:** mempool-listener multi-RPC quorum
...
- `mempool-listener multi-RPC quorum`
- `applied mempool websocket subscription in arbitragex-v2`
- `arbitragex-v2 c`
