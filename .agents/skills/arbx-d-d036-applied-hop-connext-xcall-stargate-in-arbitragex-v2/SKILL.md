...
# D036 — Applied Hop / Connext xCall / Stargate in arbitragex-v2

> **Dominio:** Multi-Chain, L2 & Bridges
> **Nivel:** Staff Engineer
> **Trigger:** arbitragex bridge selector
...
- `arbitragex bridge selector`
- `applied hop / connext xcall / stargate in arbitragex-v2`
- `arbitragex-v2 d`
