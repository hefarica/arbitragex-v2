name: arbx-c-c009-applied-sandwich-profitability-math-in-arbitragex-v2
description: "Staff Engineer skill alineada al monorepo hefarica/arbitragex-v2 (MEV, Mempool & Bundle Submission). Se activa cuando: RiskGate defensive block. Doctrina OMEGA Zero-Mocks · Fail-Closed · El Remoto Manda."
---

# C009 — Applied Sandwich Profitability Math in arbitragex-v2

> **Dominio:** MEV, Mempool & Bundle Submission
> **Nivel:** Staff Engineer
> **Trigger:** RiskGate defensive block
...
- `RiskGate defensive block`
- `applied sandwich profitability math in arbitragex-v2`
- `arbitragex-v2 c`
