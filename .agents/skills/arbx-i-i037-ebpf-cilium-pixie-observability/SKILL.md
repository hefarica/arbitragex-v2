name: arbx-i-i037-ebpf-cilium-pixie-observability
description: "PhD/Master skill alineada al monorepo hefarica/arbitragex-v2 (Observability & SRE). Se activa cuando: kernel events. Doctrina OMEGA Zero-Mocks · Fail-Closed · El Remoto Manda."
---

# I037 — eBPF / Cilium / Pixie Observability
...
- `kernel events`
- `ebpf / cilium / pixie observability`
- `arbitragex-v2 i`
