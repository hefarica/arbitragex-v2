...
# D003 — Applied OP-Stack (op-node/batcher/proposer) in arbitragex-v2

> **Dominio:** Multi-Chain, L2 & Bridges
> **Nivel:** Staff Engineer
> **Trigger:** Base/Optimism integration
...
- `Base/Optimism integration`
- `applied op-stack (op-node/batcher/proposer) in arbitragex-v2`
- `arbitragex-v2 d`
