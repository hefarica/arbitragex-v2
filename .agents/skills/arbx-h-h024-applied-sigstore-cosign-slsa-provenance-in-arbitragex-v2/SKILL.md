...
# H024 — Applied Sigstore cosign + SLSA Provenance in arbitragex-v2

> **Dominio:** CI/CD Doctrinal & DevSecOps
> **Nivel:** Staff Engineer
> **Trigger:** GHCR push attestation
...
- `GHCR push attestation`
- `applied sigstore cosign + slsa provenance in arbitragex-v2`
- `arbitragex-v2 h`
