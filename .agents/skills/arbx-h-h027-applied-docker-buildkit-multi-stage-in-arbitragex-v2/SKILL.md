name: arbx-h-h027-applied-docker-buildkit-multi-stage-in-arbitragex-v2
description: "Staff Engineer skill alineada al monorepo hefarica/arbitragex-v2 (CI/CD Doctrinal & DevSecOps). Se activa cuando: arbitragex -60% build time. Doctrina OMEGA Zero-Mocks · Fail-Closed · El Remoto Manda."
---

# H027 — Applied Docker BuildKit Multi-Stage in arbitragex-v2

> **Dominio:** CI/CD Doctrinal & DevSecOps
> **Nivel:** Staff Engineer
> **Trigger:** arbitragex -60% build time
...
- `arbitragex -60% build time`
- `applied docker buildkit multi-stage in arbitragex-v2`
- `arbitragex-v2 h`
