...
# G036 — Applied Next.js i18n + dynamic imports in arbitragex-v2

> **Dominio:** Frontend Doctrinal (Next.js + Playwright)
> **Nivel:** Staff Engineer
> **Trigger:** arbitragex multi-language UI
...
- `arbitragex multi-language UI`
- `applied next.js i18n + dynamic imports in arbitragex-v2`
- `arbitragex-v2 g`
