name: arbx-d-d024-applied-across-atomic-bridge-in-arbitragex-v2
description: "Staff Engineer skill alineada al monorepo hefarica/arbitragex-v2 (Multi-Chain, L2 & Bridges). Se activa cuando: arbitragex cross-chain rebalance. Doctrina OMEGA Zero-Mocks · Fail-Closed · El Remoto Manda."
---

# D024 — Applied Across Atomic Bridge in arbitragex-v2

> **Dominio:** Multi-Chain, L2 & Bridges
> **Nivel:** Staff Engineer
> **Trigger:** arbitragex cross-chain rebalance
...
- `arbitragex cross-chain rebalance`
- `applied across atomic bridge in arbitragex-v2`
- `arbitragex-v2 d`
