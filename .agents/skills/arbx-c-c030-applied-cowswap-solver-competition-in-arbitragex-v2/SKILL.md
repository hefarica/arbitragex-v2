name: arbx-c-c030-applied-cowswap-solver-competition-in-arbitragex-v2
description: "Staff Engineer skill alineada al monorepo hefarica/arbitragex-v2 (MEV, Mempool & Bundle Submission). Se activa cuando: arbitragex solver participant. Doctrina OMEGA Zero-Mocks · Fail-Closed · El Remoto Manda."
---

# C030 — Applied CowSwap Solver Competition in arbitragex-v2

> **Dominio:** MEV, Mempool & Bundle Submission
> **Nivel:** Staff Engineer
> **Trigger:** arbitragex solver participant
...
- `arbitragex solver participant`
- `applied cowswap solver competition in arbitragex-v2`
- `arbitragex-v2 c`
