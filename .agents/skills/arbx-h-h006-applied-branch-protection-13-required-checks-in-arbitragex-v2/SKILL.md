name: arbx-h-h006-applied-branch-protection-13-required-checks-in-arbitragex-v2
description: "Staff Engineer skill alineada al monorepo hefarica/arbitragex-v2 (CI/CD Doctrinal & DevSecOps). Se activa cuando: Bloque D RAPTOR applied. Doctrina OMEGA Zero-Mocks · Fail-Closed · El Remoto Manda."
---

# H006 — Applied Branch Protection 13 Required Checks in arbitragex-v2

> **Dominio:** CI/CD Doctrinal & DevSecOps
> **Nivel:** Staff Engineer
> **Trigger:** Bloque D RAPTOR applied
...
- `Bloque D RAPTOR applied`
- `applied branch protection 13 required checks in arbitragex-v2`
- `arbitragex-v2 h`
