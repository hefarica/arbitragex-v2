...
# E012 — Applied Balancer Spot Price Bi/Wi in arbitragex-v2

> **Dominio:** AMM Math & Quantitative DeFi
> **Nivel:** Staff Engineer
> **Trigger:** Vault single-tx multi-swap
...
- `Vault single-tx multi-swap`
- `applied balancer spot price bi/wi in arbitragex-v2`
- `arbitragex-v2 e`
