...
# G003 — Applied Next.js 15 App Router & RSC in arbitragex-v2

> **Dominio:** Frontend Doctrinal (Next.js + Playwright)
> **Nivel:** Staff Engineer
> **Trigger:** ARBX_BUILD_FOR_LOCAL_E2E iter17
...
- `ARBX_BUILD_FOR_LOCAL_E2E iter17`
- `applied next.js 15 app router & rsc in arbitragex-v2`
- `arbitragex-v2 g`
