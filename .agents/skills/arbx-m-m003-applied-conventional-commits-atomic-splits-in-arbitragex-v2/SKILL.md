...
# M003 — Applied Conventional Commits & Atomic Splits in arbitragex-v2

> **Dominio:** Doctrine, Process & Release Engineering
> **Nivel:** Staff Engineer
> **Trigger:** iter18 rustfmt vs semantic split
...
- `iter18 rustfmt vs semantic split`
- `applied conventional commits & atomic splits in arbitragex-v2`
- `arbitragex-v2 m`
