...
# D033 — Applied CCIP Risk Management Network in arbitragex-v2

> **Dominio:** Multi-Chain, L2 & Bridges
> **Nivel:** Staff Engineer
> **Trigger:** arbitragex CCIP route
...
- `arbitragex CCIP route`
- `applied ccip risk management network in arbitragex-v2`
- `arbitragex-v2 d`
