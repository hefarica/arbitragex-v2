...
# I012 — Applied Loki LogQL + Promtail in arbitragex-v2

> **Dominio:** Observability & SRE
> **Nivel:** Staff Engineer
> **Trigger:** centralized VPS log shipping
...
- `centralized VPS log shipping`
- `applied loki logql + promtail in arbitragex-v2`
- `arbitragex-v2 i`
