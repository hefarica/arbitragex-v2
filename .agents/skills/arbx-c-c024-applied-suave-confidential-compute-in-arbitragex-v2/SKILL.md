name: arbx-c-c024-applied-suave-confidential-compute-in-arbitragex-v2
description: "Staff Engineer skill alineada al monorepo hefarica/arbitragex-v2 (MEV, Mempool & Bundle Submission). Se activa cuando: cross-domain MEV POC. Doctrina OMEGA Zero-Mocks · Fail-Closed · El Remoto Manda."
---

# C024 — Applied SUAVE Confidential Compute in arbitragex-v2

> **Dominio:** MEV, Mempool & Bundle Submission
> **Nivel:** Staff Engineer
> **Trigger:** cross-domain MEV POC
...
- `cross-domain MEV POC`
- `applied suave confidential compute in arbitragex-v2`
- `arbitragex-v2 c`
