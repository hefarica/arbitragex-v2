...
# K024 — Applied Supply Chain (lockfile/sigstore/SLSA) in arbitragex-v2

> **Dominio:** Security & Cryptography Applied
> **Nivel:** Staff Engineer
> **Trigger:** arbitragex SBOM in release
...
- `arbitragex SBOM in release`
- `applied supply chain (lockfile/sigstore/slsa) in arbitragex-v2`
- `arbitragex-v2 k`
