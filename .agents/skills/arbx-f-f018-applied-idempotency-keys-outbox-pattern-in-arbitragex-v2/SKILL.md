name: arbx-f-f018-applied-idempotency-keys-outbox-pattern-in-arbitragex-v2
description: "Staff Engineer skill alineada al monorepo hefarica/arbitragex-v2 (Backend Services (Node + Rust)). Se activa cuando: executor-rs exactly-once. Doctrina OMEGA Zero-Mocks · Fail-Closed · El Remoto Manda."
---

# F018 — Applied Idempotency Keys & Outbox Pattern in arbitragex-v2

> **Dominio:** Backend Services (Node + Rust)
> **Nivel:** Staff Engineer
> **Trigger:** executor-rs exactly-once
...
- `executor-rs exactly-once`
- `applied idempotency keys & outbox pattern in arbitragex-v2`
- `arbitragex-v2 f`
