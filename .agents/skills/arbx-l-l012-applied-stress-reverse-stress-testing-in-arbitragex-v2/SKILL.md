name: arbx-l-l012-applied-stress-reverse-stress-testing-in-arbitragex-v2
description: "Staff Engineer skill alineada al monorepo hefarica/arbitragex-v2 (Risk, Backtesting & Quant Engineering). Se activa cuando: pre-deploy stress validate. Doctrina OMEGA Zero-Mocks · Fail-Closed · El Remoto Manda."
---

# L012 — Applied Stress & Reverse Stress Testing in arbitragex-v2

> **Dominio:** Risk, Backtesting & Quant Engineering
> **Nivel:** Staff Engineer
> **Trigger:** pre-deploy stress validate
...
- `pre-deploy stress validate`
- `applied stress & reverse stress testing in arbitragex-v2`
- `arbitragex-v2 l`
