...
# D012 — Applied Scroll zkEVM Equivalence in arbitragex-v2

> **Dominio:** Multi-Chain, L2 & Bridges
> **Nivel:** Staff Engineer
> **Trigger:** L1↔L2 bridge monitor
...
- `L1↔L2 bridge monitor`
- `applied scroll zkevm equivalence in arbitragex-v2`
- `arbitragex-v2 d`
