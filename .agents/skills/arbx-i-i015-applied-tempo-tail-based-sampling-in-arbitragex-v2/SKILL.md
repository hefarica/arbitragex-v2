name: arbx-i-i015-applied-tempo-tail-based-sampling-in-arbitragex-v2
description: "Staff Engineer skill alineada al monorepo hefarica/arbitragex-v2 (Observability & SRE). Se activa cuando: Prom→Tempo navigation. Doctrina OMEGA Zero-Mocks · Fail-Closed · El Remoto Manda."
---

# I015 — Applied Tempo Tail-Based Sampling in arbitragex-v2

> **Dominio:** Observability & SRE
> **Nivel:** Staff Engineer
> **Trigger:** Prom→Tempo navigation
...
- `Prom→Tempo navigation`
- `applied tempo tail-based sampling in arbitragex-v2`
- `arbitragex-v2 i`
