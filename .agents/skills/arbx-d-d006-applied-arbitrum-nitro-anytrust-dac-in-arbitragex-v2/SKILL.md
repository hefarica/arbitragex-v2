...
# D006 — Applied Arbitrum Nitro AnyTrust DAC in arbitragex-v2

> **Dominio:** Multi-Chain, L2 & Bridges
> **Nivel:** Staff Engineer
> **Trigger:** Inbox L1→L2 tracking
...
- `Inbox L1→L2 tracking`
- `applied arbitrum nitro anytrust dac in arbitragex-v2`
- `arbitragex-v2 d`
