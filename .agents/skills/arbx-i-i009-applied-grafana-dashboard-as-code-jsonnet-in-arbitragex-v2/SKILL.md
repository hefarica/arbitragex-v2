...
# I009 — Applied Grafana Dashboard-as-Code (Jsonnet) in arbitragex-v2

> **Dominio:** Observability & SRE
> **Nivel:** Staff Engineer
> **Trigger:** Topological Yield realtime
...
- `Topological Yield realtime`
- `applied grafana dashboard-as-code (jsonnet) in arbitragex-v2`
- `arbitragex-v2 i`
