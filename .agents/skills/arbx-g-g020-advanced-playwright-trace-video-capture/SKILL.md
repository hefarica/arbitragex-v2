name: arbx-g-g020-advanced-playwright-trace-video-capture
description: "Post-Doc skill alineada al monorepo hefarica/arbitragex-v2 (Frontend Doctrinal (Next.js + Playwright)). Se activa cuando: forensic flake research. Doctrina OMEGA Zero-Mocks · Fail-Closed · El Remoto Manda."
---

# G020 — Advanced Playwright Trace & Video Capture

> **Dominio:** Frontend Doctrinal (Next.js + Playwright)
> **Nivel:** Post-Doc
> **Trigger:** forensic flake research
...
- `forensic flake research`
- `advanced playwright trace & video capture`
- `arbitragex-v2 g`
