...
# J009 — Applied Postgres CTE & Window + Recursive in arbitragex-v2

> **Dominio:** Database & Storage (Postgres/Redis/Timescale)
> **Nivel:** Staff Engineer
> **Trigger:** multi-hop arb path queries
...
- `multi-hop arb path queries`
- `applied postgres cte & window + recursive in arbitragex-v2`
- `arbitragex-v2 j`
