...
# C045 — Applied Bundle Replacement & UUID in arbitragex-v2

> **Dominio:** MEV, Mempool & Bundle Submission
> **Nivel:** Staff Engineer
> **Trigger:** cancel/replace ergonomics
...
- `cancel/replace ergonomics`
- `applied bundle replacement & uuid in arbitragex-v2`
- `arbitragex-v2 c`
