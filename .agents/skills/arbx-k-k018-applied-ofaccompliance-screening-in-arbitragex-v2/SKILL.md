...
# K018 — Applied OFAC/Compliance Screening in arbitragex-v2

> **Dominio:** Security & Cryptography Applied
> **Nivel:** Staff Engineer
> **Trigger:** compliance-screener-rs gate
...
- `compliance-screener-rs gate`
- `applied ofac/compliance screening in arbitragex-v2`
- `arbitragex-v2 k`
