name: arbx-d-d021-applied-eigenda-celestia-avail-in-arbitragex-v2
description: "Staff Engineer skill alineada al monorepo hefarica/arbitragex-v2 (Multi-Chain, L2 & Bridges). Se activa cuando: arbitragex DA fallback. Doctrina OMEGA Zero-Mocks · Fail-Closed · El Remoto Manda."
---

# D021 — Applied EigenDA / Celestia / Avail in arbitragex-v2

> **Dominio:** Multi-Chain, L2 & Bridges
> **Nivel:** Staff Engineer
> **Trigger:** arbitragex DA fallback
...
- `arbitragex DA fallback`
- `applied eigenda / celestia / avail in arbitragex-v2`
- `arbitragex-v2 d`
