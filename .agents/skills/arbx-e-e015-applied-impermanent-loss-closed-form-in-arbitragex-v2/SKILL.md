...
# E015 — Applied Impermanent Loss Closed-Form in arbitragex-v2

> **Dominio:** AMM Math & Quantitative DeFi
> **Nivel:** Staff Engineer
> **Trigger:** per-position IL display
...
- `per-position IL display`
- `applied impermanent loss closed-form in arbitragex-v2`
- `arbitragex-v2 e`
