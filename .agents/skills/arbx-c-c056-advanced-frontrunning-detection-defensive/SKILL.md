name: arbx-c-c056-advanced-frontrunning-detection-defensive
description: "Post-Doc skill alineada al monorepo hefarica/arbitragex-v2 (MEV, Mempool & Bundle Submission). Se activa cuando: ML signature detection. Doctrina OMEGA Zero-Mocks · Fail-Closed · El Remoto Manda."
---

# C056 — Advanced Frontrunning Detection (Defensive)

> **Dominio:** MEV, Mempool & Bundle Submission
> **Nivel:** Post-Doc
> **Trigger:** ML signature detection
...
- `advanced frontrunning detection (defensive)`
- `arbitragex-v2 c`
