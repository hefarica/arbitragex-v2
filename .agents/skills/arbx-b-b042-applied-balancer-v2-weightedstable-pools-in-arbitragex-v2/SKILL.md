...
# B042 — Applied Balancer V2 Weighted/Stable Pools in arbitragex-v2

> **Dominio:** Smart Contracts, Solidity & Auditing
> **Nivel:** Staff Engineer
> **Trigger:** single-vault multi-swap
...
- `single-vault multi-swap`
- `applied balancer v2 weighted/stable pools in arbitragex-v2`
- `arbitragex-v2 b`
