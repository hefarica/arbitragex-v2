...
# I027 — Applied Runbooks-as-Code Linked from Alerts in arbitragex-v2

> **Dominio:** Observability & SRE
> **Nivel:** Staff Engineer
> **Trigger:** arbitragex runbook repo
...
- `arbitragex runbook repo`
- `applied runbooks-as-code linked from alerts in arbitragex-v2`
- `arbitragex-v2 i`
