...
# A012 — Applied sqlx Compile-Time Query Verification in arbitragex-v2

> **Dominio:** Rust Systems & Searcher Engine
> **Nivel:** Staff Engineer
> **Trigger:** pool_sync_worker.rs
...
- `pool_sync_worker.rs`
- `applied sqlx compile-time query verification in arbitragex-v2`
- `arbitragex-v2 a`
