name: arbx-l-l021-applied-drawdown-control-stop-trading-in-arbitragex-v2
description: "Staff Engineer skill alineada al monorepo hefarica/arbitragex-v2 (Risk, Backtesting & Quant Engineering). Se activa cuando: auto-halt >2σ DD. Doctrina OMEGA Zero-Mocks · Fail-Closed · El Remoto Manda."
---

# L021 — Applied Drawdown Control Stop-Trading in arbitragex-v2

> **Dominio:** Risk, Backtesting & Quant Engineering
> **Nivel:** Staff Engineer
> **Trigger:** auto-halt >2σ DD
...
- `auto-halt >2σ DD`
- `applied drawdown control stop-trading in arbitragex-v2`
- `arbitragex-v2 l`
