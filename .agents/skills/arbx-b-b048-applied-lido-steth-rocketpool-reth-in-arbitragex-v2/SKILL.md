...
# B048 — Applied Lido stETH / Rocketpool rETH in arbitragex-v2

> **Dominio:** Smart Contracts, Solidity & Auditing
> **Nivel:** Staff Engineer
> **Trigger:** liquid staking yield route
...
- `liquid staking yield route`
- `applied lido steth / rocketpool reth in arbitragex-v2`
- `arbitragex-v2 b`
