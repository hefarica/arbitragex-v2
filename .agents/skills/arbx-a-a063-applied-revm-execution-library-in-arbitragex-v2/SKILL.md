name: arbx-a-a063-applied-revm-execution-library-in-arbitragex-v2
description: "Staff Engineer skill alineada al monorepo hefarica/arbitragex-v2 (Rust Systems & Searcher Engine). Se activa cuando: sim-ctl pre-trade simulation. Doctrina OMEGA Zero-Mocks · Fail-Closed · El Remoto Manda."
---

# A063 — Applied revm Execution Library in arbitragex-v2

> **Dominio:** Rust Systems & Searcher Engine
> **Nivel:** Staff Engineer
> **Trigger:** sim-ctl pre-trade simulation
...
- `sim-ctl pre-trade simulation`
- `applied revm execution library in arbitragex-v2`
- `arbitragex-v2 a`
