...
export const ScoredRecordSchema = z.object({
  ...
  /**
   * §IV fold (Stage 2c, BR-05 (2026-09-07)): prior_log_odds + Σ (log_lr_k · e_k)
   * from the calibrated per-operator store (`math_operator_calibration`, mirrored
   * by the searcher's PriorsCache). null when either side (evidence snapshot,
