/**
 * Sprint 3 Task 3.2 — Zod schemas for /operations endpoint responses.
 *
 * Mirrored client-side at frontend/lib/operations-schemas.ts. Field names
 * use snake_case to match the JSON shape the server emits, while pmiCalculator
 * outputs camelCase — the router translates between the two at the boundary.
 */
import { z } from "zod";
