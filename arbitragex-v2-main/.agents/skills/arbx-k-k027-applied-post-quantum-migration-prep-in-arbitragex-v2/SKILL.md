...
# K027 — Applied Post-Quantum Migration Prep in arbitragex-v2

> **Dominio:** Security & Cryptography Applied
> **Nivel:** Staff Engineer
> **Trigger:** post-quantum readiness ADR
...
- `post-quantum readiness ADR`
- `applied post-quantum migration prep in arbitragex-v2`
- `arbitragex-v2 k`
