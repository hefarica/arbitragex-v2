...
# E018 — Applied Slippage & Price Impact Decomposition in arbitragex-v2

> **Dominio:** AMM Math & Quantitative DeFi
> **Nivel:** Staff Engineer
> **Trigger:** RiskGate slippage bands
...
- `RiskGate slippage bands`
- `applied slippage & price impact decomposition in arbitragex-v2`
- `arbitragex-v2 e`
