name: arbx-d-d031-ccip-risk-management-network
description: "PhD/Master skill alineada al monorepo hefarica/arbitragex-v2 (Multi-Chain, L2 & Bridges). Se activa cuando: lane operators. Doctrina OMEGA Zero-Mocks · Fail-Closed · El Remoto Manda."
---

# D031 — CCIP Risk Management Network

> **Dominio:** Multi-Chain, L2 & Bridges
> **Nivel:** PhD/Master
> **Trigger:** lane operators
