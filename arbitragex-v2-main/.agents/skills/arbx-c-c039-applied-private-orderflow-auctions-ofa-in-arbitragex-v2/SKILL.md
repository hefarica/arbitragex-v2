name: arbx-c-c039-applied-private-orderflow-auctions-ofa-in-arbitragex-v2
description: "Staff Engineer skill alineada al monorepo hefarica/arbitragex-v2 (MEV, Mempool & Bundle Submission). Se activa cuando: OFA hint subscriber. Doctrina OMEGA Zero-Mocks · Fail-Closed · El Remoto Manda."
---

# C039 — Applied Private Orderflow Auctions (OFA) in arbitragex-v2

> **Dominio:** MEV, Mempool & Bundle Submission
> **Nivel:** Staff Engineer
> **Trigger:** OFA hint subscriber
...
- `OFA hint subscriber`
- `applied private orderflow auctions (ofa) in arbitragex-v2`
- `arbitragex-v2 c`
