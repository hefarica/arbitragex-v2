name: arbx-f-f028-feature-flags-unleashopenfeature
description: "PhD/Master skill alineada al monorepo hefarica/arbitragex-v2 (Backend Services (Node + Rust)). Se activa cuando: progressive rollout. Doctrina OMEGA Zero-Mocks · Fail-Closed · El Remoto Manda."
---

# F028 — Feature Flags (Unleash/OpenFeature)
