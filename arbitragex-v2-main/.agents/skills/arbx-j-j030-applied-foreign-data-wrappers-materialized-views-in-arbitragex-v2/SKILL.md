...
# J030 — Applied Foreign Data Wrappers + Materialized Views in arbitragex-v2

> **Dominio:** Database & Storage (Postgres/Redis/Timescale)
> **Nivel:** Staff Engineer
> **Trigger:** analytics view refresh
...
- `applied foreign data wrappers + materialized views in arbitragex-v2`
- `arbitragex-v2 j`
