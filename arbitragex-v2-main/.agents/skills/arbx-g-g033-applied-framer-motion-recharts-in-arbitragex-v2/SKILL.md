name: arbx-g-g033-applied-framer-motion-recharts-in-arbitragex-v2
description: "Staff Engineer skill alineada al monorepo hefarica/arbitragex-v2 (Frontend Doctrinal (Next.js + Playwright)). Se activa cuando: Topological Yield chart. Doctrina OMEGA Zero-Mocks · Fail-Closed · El Remoto Manda."
---

# G033 — Applied Framer Motion + recharts in arbitragex-v2

> **Dominio:** Frontend Doctrinal (Next.js + Playwright)
> **Nivel:** Staff Engineer
> **Trigger:** Topological Yield chart
...
- `Topological Yield chart`
- `applied framer motion + recharts in arbitragex-v2`
- `arbitragex-v2 g`
