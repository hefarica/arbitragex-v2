...
# F021 — Applied Structured Logging (pino) + Correlation IDs in arbitragex-v2

> **Dominio:** Backend Services (Node + Rust)
> **Nivel:** Staff Engineer
> **Trigger:** x-request-id surface
...
- `x-request-id surface`
- `applied structured logging (pino) + correlation ids in arbitragex-v2`
- `arbitragex-v2 f`
