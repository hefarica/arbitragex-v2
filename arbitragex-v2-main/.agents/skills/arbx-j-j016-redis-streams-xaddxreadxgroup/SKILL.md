name: arbx-j-j016-redis-streams-xaddxreadxgroup
description: "PhD/Master skill alineada al monorepo hefarica/arbitragex-v2 (Database & Storage (Postgres/Redis/Timescale)). Se activa cuando: consumer groups. Doctrina OMEGA Zero-Mocks · Fail-Closed · El Remoto Manda."
---

# J016 — Redis Streams XADD/XREAD/XGROUP

> **Dominio:** Database & Storage (Postgres/Redis/Timescale)
> **Nivel:** PhD/Master
> **Trigger:** consumer groups
