...
# E027 — Applied Monte Carlo Path Simulation in arbitragex-v2

> **Dominio:** AMM Math & Quantitative DeFi
> **Nivel:** Staff Engineer
> **Trigger:** nightly backtest realistic PnL
...
- `nightly backtest realistic PnL`
- `applied monte carlo path simulation in arbitragex-v2`
- `arbitragex-v2 e`
