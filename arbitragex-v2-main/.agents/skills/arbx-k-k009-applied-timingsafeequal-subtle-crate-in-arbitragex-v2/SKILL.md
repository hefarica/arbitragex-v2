...
# K009 — Applied timingSafeEqual & subtle crate in arbitragex-v2

> **Dominio:** Security & Cryptography Applied
> **Nivel:** Staff Engineer
> **Trigger:** require-service-token RAPTOR
...
- `require-service-token RAPTOR`
- `applied timingsafeequal & subtle crate in arbitragex-v2`
- `arbitragex-v2 k`
