...
# B012 — Applied Solady SafeTransferLib & FixedPointMath in arbitragex-v2

> **Dominio:** Smart Contracts, Solidity & Auditing
> **Nivel:** Staff Engineer
> **Trigger:** -2k gas per swap
...
- `-2k gas per swap`
- `applied solady safetransferlib & fixedpointmath in arbitragex-v2`
- `arbitragex-v2 b`
