...
# D009 — Applied zkSync Era Boojum Prover in arbitragex-v2

> **Dominio:** Multi-Chain, L2 & Bridges
> **Nivel:** Staff Engineer
> **Trigger:** Era Paymaster gasless
...
- `Era Paymaster gasless`
- `applied zksync era boojum prover in arbitragex-v2`
- `arbitragex-v2 d`
