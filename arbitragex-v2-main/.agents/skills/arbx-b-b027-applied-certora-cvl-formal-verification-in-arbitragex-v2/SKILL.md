...
# B027 — Applied Certora CVL Formal Verification in arbitragex-v2

> **Dominio:** Smart Contracts, Solidity & Auditing
> **Nivel:** Staff Engineer
> **Trigger:** never-lose-principal invariants
...
- `never-lose-principal invariants`
- `applied certora cvl formal verification in arbitragex-v2`
- `arbitragex-v2 b`
