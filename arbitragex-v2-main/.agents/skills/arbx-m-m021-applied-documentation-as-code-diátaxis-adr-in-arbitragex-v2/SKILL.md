...
# M021 — Applied Documentation as Code (Diátaxis + ADR) in arbitragex-v2

> **Dominio:** Doctrine, Process & Release Engineering
> **Nivel:** Staff Engineer
> **Trigger:** tripartite status ADR iter18
...
- `tripartite status ADR iter18`
- `applied documentation as code (diátaxis + adr) in arbitragex-v2`
- `arbitragex-v2 m`
