...
# C060 — Applied Block Builder Tip Optimization in arbitragex-v2

> **Dominio:** MEV, Mempool & Bundle Submission
> **Nivel:** Staff Engineer
> **Trigger:** executor-rs adaptive tip
...
- `executor-rs adaptive tip`
- `applied block builder tip optimization in arbitragex-v2`
- `arbitragex-v2 c`
