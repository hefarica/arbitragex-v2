...
# L006 — Applied Slippage Modeling Historical Mempool in arbitragex-v2

> **Dominio:** Risk, Backtesting & Quant Engineering
> **Nivel:** Staff Engineer
> **Trigger:** gas-adjusted backtester
...
- `gas-adjusted backtester`
- `applied slippage modeling historical mempool in arbitragex-v2`
- `arbitragex-v2 l`
