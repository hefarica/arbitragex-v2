...
# C054 — Applied MEV Inspector Tools (mev-inspect) in arbitragex-v2

> **Dominio:** MEV, Mempool & Bundle Submission
> **Nivel:** Staff Engineer
> **Trigger:** nightly retro analysis
...
- `nightly retro analysis`
- `applied mev inspector tools (mev-inspect) in arbitragex-v2`
- `arbitragex-v2 c`
