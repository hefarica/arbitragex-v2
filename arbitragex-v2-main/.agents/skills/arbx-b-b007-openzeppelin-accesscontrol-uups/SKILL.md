name: arbx-b-b007-openzeppelin-accesscontrol-uups
description: "PhD/Master skill alineada al monorepo hefarica/arbitragex-v2 (Smart Contracts, Solidity & Auditing). Se activa cuando: role-based upgradeable. Doctrina OMEGA Zero-Mocks · Fail-Closed · El Remoto Manda."
---

# B007 — OpenZeppelin AccessControl & UUPS

> **Dominio:** Smart Contracts, Solidity & Auditing
> **Nivel:** PhD/Master
> **Trigger:** role-based upgradeable
...
- `role-based upgradeable`
- `openzeppelin accesscontrol & uups`
- `arbitragex-v2 b`
