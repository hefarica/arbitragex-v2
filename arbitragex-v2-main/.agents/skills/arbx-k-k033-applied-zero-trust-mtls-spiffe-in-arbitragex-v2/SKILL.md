...
# K033 — Applied Zero-Trust + mTLS + SPIFFE in arbitragex-v2

> **Dominio:** Security & Cryptography Applied
> **Nivel:** Staff Engineer
> **Trigger:** arbitragex zero-trust mesh
...
- `arbitragex zero-trust mesh`
- `applied zero-trust + mtls + spiffe in arbitragex-v2`
- `arbitragex-v2 k`
