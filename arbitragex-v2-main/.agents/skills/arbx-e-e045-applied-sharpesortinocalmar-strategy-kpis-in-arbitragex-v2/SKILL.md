...
# E045 — Applied Sharpe/Sortino/Calmar Strategy KPIs in arbitragex-v2

> **Dominio:** AMM Math & Quantitative DeFi
> **Nivel:** Staff Engineer
> **Trigger:** Grafana strategy panel
...
- `Grafana strategy panel`
- `applied sharpe/sortino/calmar strategy kpis in arbitragex-v2`
- `arbitragex-v2 e`
