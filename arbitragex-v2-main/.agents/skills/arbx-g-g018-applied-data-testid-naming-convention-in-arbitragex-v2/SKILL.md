...
# G018 — Applied data-testid Naming Convention in arbitragex-v2

> **Dominio:** Frontend Doctrinal (Next.js + Playwright)
> **Nivel:** Staff Engineer
> **Trigger:** ServicesTable+ControlPanel iter18
...
- `ServicesTable+ControlPanel iter18`
- `applied data-testid naming convention in arbitragex-v2`
- `arbitragex-v2 g`
