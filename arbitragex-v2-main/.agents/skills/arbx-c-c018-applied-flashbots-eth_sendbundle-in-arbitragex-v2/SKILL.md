name: arbx-c-c018-applied-flashbots-eth_sendbundle-in-arbitragex-v2
description: "Staff Engineer skill alineada al monorepo hefarica/arbitragex-v2 (MEV, Mempool & Bundle Submission). Se activa cuando: multi-builder rotation. Doctrina OMEGA Zero-Mocks · Fail-Closed · El Remoto Manda."
---

# C018 — Applied Flashbots eth_sendBundle in arbitragex-v2

> **Dominio:** MEV, Mempool & Bundle Submission
> **Nivel:** Staff Engineer
> **Trigger:** multi-builder rotation
...
- `multi-builder rotation`
- `applied flashbots eth_sendbundle in arbitragex-v2`
- `arbitragex-v2 c`
