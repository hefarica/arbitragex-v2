...
264 canonical + the 99-series TEST negative-control sentinel (literal elided by
the 2026-09-01 exact-264 closure — concat-constructed at every use site since) + one elided doc
