...
| **G-CI-1** | e2e workflow roto repo-wide | **OPEN** | — | — | `actions/cache@0057852bfaa89a56755ef8b1d83041146aa5d7` (pin v4.2.4) inresoluble → `e2e.yml` y `cartridge-integration-deploy.yml` fallan en "Set up job" (25/25 runs). NO bloquea merge (precedente #416) PERO deja el flujo Post-E2E sin señal real y contribuye al no-op del auto-deploy. Fix: repin a SHA válido de actions/cache v4.2.4 (o v4 tag). | 2026-08-19 |
